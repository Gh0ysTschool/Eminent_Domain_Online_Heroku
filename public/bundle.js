...
var app = function () {
  ...
  var methods = {
      ...
      if (app.get().lobby.screenname == app.get().game.players[app.get().game.acting_player_index].name || !app.get().lobby.online) {
        if (!game[game.displayinfo.choicelabel].includes(choice)) {
          ...
          if (choice.type !== 'planet' && choice.type !== 'fertile' && choice.type !== 'metallic' && choice.type !== 'advanced' && choice.name != 'Skip') {
            ...
            game.players[game.acting_player_index].hand = game.players[game.acting_player_index].hand.filter(el => {
          ...
          if (choice.type !== 'planet' && choice.type !== 'fertile' && choice.type !== 'metallic' && choice.type !== 'advanced' && choice.name != 'Skip') {
            game[game.displayinfo.choicelabel] = game[game.displayinfo.choicelabel].filter(el => {
              return el.identifier != choice.identifier;
            });
            game.players[app.get().game.acting_player_index].hand.push(choice);
            game.players[app.get().game.acting_player_index].limbo = game.players[game.acting_player_index].limbo.filter(el => {
              return el.identifier != choice.identifier;
            });
          }
        }
    ...
    unchoose(choice) {
      if (app.get().lobby.screenname == app.get().game.players[app.get().game.acting_player_index].name || !app.get().lobby.online) {
        ...
        if (game[game.displayinfo.choicelabel].includes(choice)) {
          ...
          game.players[game.acting_player_index].limbo = game.players[game.acting_player_index].limbo.filter(el => {
            return el.identifier != choice.identifier;
          });
          game[game.displayinfo.choicelabel] = game[game.displayinfo.choicelabel].filter(el => {
            return el.identifier != choice.identifier;
    ...
    totalinfluence() {
      ...
      app.set({
        'game': _objectSpread({}, app.get().game, {
          'players': players
        })
      });
    },
    ...
    endgame() {
      ...
      app.get().ws.send(JSON.stringify(_objectSpread({}, app.get().game, {
        header: 'remove'
      })));
    },
    ...
    generate_research_card(name) {
      let _card = {
        ...
        improved_colonize: function improved_colonize() {
          this.research(3);
          this.imgurl += "improvedcolonize";
          return this;
        },
        improved_survey: function improved_survey() {
          this.research(3);
          this.imgurl += "improvedsurvey";
          return this;
        },
        improved_research: function improved_research() {
          this.research(3);
          this.imgurl += "improvedresearch";
          return this;
        },
        improved_warfare: function improved_warfare() {
          this.research(3);
          this.imgurl += "improvedwarfare";
          return this;
        },
        improved_production: function improved_production() {
          this.research(3);
          this.imgurl += "improvedproduction";
          return this;
        },
        improved_trade: function improved_trade() {
          this.research(3);
          this.imgurl += "improvedtrade";
          return this;
        },
        surveyteam: function surveyteam() {
          return this.research(5).metallic(2).influence(2).icons({
            'survey': 2
          }).img('surveyteam');
        },
        warpath: function warpath() {
          return this.research(5).metallic(2).influence(2).icons({
            'warfare': 2
          }).img('warpath');
        },
        terraforming: function terraforming() {
          return this.research(5).fertile(2).influence(2).icons({
            'colonize': 2
          }).img('terraforming');
        },
        geneticengineering: function geneticengineering() {
          return this.research(5).fertile(2).influence(2).icons({
            'produce': 2
          }).img('geneticengineering');
        },
        artificialintelligence: function artificialintelligence() {
          return this.research(5).fertile(2).influence(2).icons({
            'colonize': 1,
            'produce': 1
          }).img('artificialintelligence');
        },
        diversemarkets: function diversemarkets() {
        ...
        mobilization: function mobilization() {
          return this.research(5).metallic(2).influence(2).icons({
            'survey': 1,
            'warfare': 1
          }).img('mobilization');
        },
        datanetwork: function datanetwork() {
          return this.research(5).advanced(2).influence(2).icons({
            'research': 2
          }).img('datanetwork');
        },
        ...
        adaptability: function adaptability() {
          this.research(7);
        ...
        bureaucracy: function bureaucracy() {
          this.research(7);
    ...
    generate_research_deck() {
      let _deck = [app.generate_research_card('improved_production').metallic(1).icons({
        'warfare': 1,
        'produce': 1
    ...
    settle_colonies(planet, possessing_player) {
      ...
      if (planet.settle_cost - reduction <= planet.hosted_colonies.length) {
        if (app.get().game.players[app.get().game.acting_player_index].permanents.filter(el => {
    ...
    produce(planets) {
      let resources = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      let game = app.get().game;
      let prd = {
        blue: 0,
        green: 0,
      ...
      for (let i in planets) {
        let p = planets[i];
        game.players[game.acting_player_index].planets = game.players[game.acting_player_index].planets.filter(e => {
    ...
    trade(planets, player) {
      let resources = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
      let game = app.get().game;
      let prd = {
        blue: 0,
        green: 0,
    ...
    //research hand->exile
    research(cards, player) {
      let limit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
    ...
    boost(cards, player) {
      for (let i = 0; i < cards.length; i++) {
        for (let j = 0; j < cards[i].icons.length; j++) {
          let _cards$i$icons$j = _slicedToArray(cards[i].icons[j], 2),
              key = _cards$i$icons$j[0],
              value = _cards$i$icons$j[1];
    ...
    colonize(planet, source_array, card) {
      let isRole = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      let temp_array = [];
      let removed = false;
    ...
    explore_planet(player) {
      ...
      player.limbo.push(_objectSpread({
    ...
    discardcardsfromhand(choices) {
      ...
      let _arguments2 = Array.prototype.slice.call(arguments),
    ...
    phasefinishfunction() {
      let send = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    ...
    generategamesequence() {
      let game = app.get().game;
      let _gamesequence = [];
      _gamesequence = app.gshelper([...game.gamephases[0].start], _gamesequence); //ar. ra, aar, ara, raa
    ...
    gshelper(source_array, destination_array) {
      let wrapperfunction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    newgame(number_of_players) {
      let sets = app.get().lobby.sets; //returns {game_id, game_name, number_of_players, slots}

      let ws = new WebSocket(app.get().lobby.url); //let ws = new io(app.get().lobby.url);
    ...
    sendstate() {
      ...
      if (ws.readyState == 1) {
        ws.send(JSON.stringify(_objectSpread({}, app.get().game, {
          'header': 'set',
    ...
    move(evt, img) {
      let touch = evt.targetTouches[0]; // Place element where the finger is
  ...
  function click_handler_15(event) {
    const _this$_svelte2 = this._svelte,
  ...
  function tap_handler_14(event) {
    const _this$_svelte3 = this._svelte,
  ...
  function click_handler_14(event) {
    const _this$_svelte4 = this._svelte,
  ...
  function tap_handler_13(event) {
    const _this$_svelte5 = this._svelte,
  ...
  function touchmove_handler_2(event) {
    const _this$_svelte6 = this._svelte,
  ...
  function click_handler_13(event) {
    const _this$_svelte7 = this._svelte,
  ...
  function touchend_handler_2(event) {
    const component = this._svelte.component;
    component.drop(event, 'hand');
  }

  function touchstart_handler_2(event) {
    const _this$_svelte8 = this._svelte,
  ...
  function tap_handler_12(event) {
    const _this$_svelte9 = this._svelte,
  ...
  function click_handler_12(event) {
    const _this$_svelte10 = this._svelte,
  ...
  function touchmove_handler_1(event) {
    const _this$_svelte11 = this._svelte,
  ...
  function touchstart_handler_1(event) {
    const _this$_svelte12 = this._svelte,
  ...
  function tap_handler_11(event) {
    const _this$_svelte13 = this._svelte,
  ...
  function click_handler_11(event) {
    const _this$_svelte14 = this._svelte,
  ...
  function tap_handler_8(event) {
    const _this$_svelte15 = this._svelte,
  ...
  function click_handler_8(event) {
    const _this$_svelte16 = this._svelte,
  ...
  function tap_handler_7(event) {
    const _this$_svelte17 = this._svelte,
  ...
  function click_handler_7(event) {
    const _this$_svelte18 = this._svelte,
  ...
  function tap_handler_5(event) {
    const _this$_svelte19 = this._svelte,
  ...
  function click_handler_5(event) {
    const _this$_svelte20 = this._svelte,
  ...
  function tap_handler_4(event) {
    const _this$_svelte21 = this._svelte,
  ...
  function click_handler_4(event) {
    const _this$_svelte22 = this._svelte,
  ...
  function touchstart_handler(event) {
    const _this$_svelte23 = this._svelte,
  ...
  function touchmove_handler(event) {
    const _this$_svelte24 = this._svelte,
  ...
  function tap_handler_3(event) {
    const _this$_svelte25 = this._svelte,
  ...
  function click_handler_3(event) {
    const _this$_svelte26 = this._svelte,
  ...
  function tap_handler_2(event) {
    const _this$_svelte27 = this._svelte,
  ...
  function click_handler_2(event) {
    const _this$_svelte28 = this._svelte,
  ...
  function tap_handler(event) {
    const _this$_svelte29 = this._svelte,
  ...
  function click_handler(event) {
    const _this$_svelte30 = this._svelte,
  ...
  let game = {
    ...
    gamephases: [//logic for detecting startofgame, endofgame, changeofpriority, and reseting the phasequeue
    {
      start: [{
        ...
        Productivity: () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].permanents.filter(el => {
        ...
        Logistics: () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].permanents.filter(el => {
            ...
            if (app$1.get().game.choices[0].name == "Action Phase then Role Phase") {
              game.players[app$1.get().game.acting_player_index].actionrolesequence = "ar";
            } else if (app$1.get().game.choices[0].name == "Role Phase then Action Phase") {
              game.players[app$1.get().game.acting_player_index].actionrolesequence = "ra";
              ...
              game.players[app$1.get().game.acting_player_index].actionrolesequence = "ara";
            } else if (app$1.get().game.choices[0].name == "Role Phase then Action Phase then another Action Phase") {
              game.players[app$1.get().game.acting_player_index].actionrolesequence = "raa";
            }
      ...
      //add an extra action
      {
        ...
        "Playing your Action": () => {
          if (app$1.get().game.choices[0].name == "Skip") {
            ...
            let _app$1$get = app$1.get(),
                game = _app$1$get.game,
      ...
      //         -> colonize
      {
        ...
        "Colonizing your Planet": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "colonize" || app$1.get().game.choices[0].name != "Colonize") {
            ...
            app$1.colonize(app$1.get().game.subchoices[0], app$1.get().game.players[app$1.get().game.acting_player_index].limbo, app$1.get().game.players[app$1.get().game.acting_player_index].limbo.filter(el => {
      ...
      //          -> politics
      {
        ...
        "Swapping the Role Card for your Politics Card": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "politics") {
            ...
            app$1.politics(app$1.get().game.players[app$1.get().game.acting_player_index].limbo.filter(el => {
      ...
      //      -> survey_team
      {
        "Adding Top Card of the Planet deck to your Empire": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "survey_team") {
            ...
            let _app$1$get2 = app$1.get(),
                game = _app$1$get2.game,
      ...
      //      -> terraforming
      {
        ...
        "Terraforming your Planet": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "terraforming" || app$1.get().game.choices[0].name != "Colonize") {
            ...
            app$1.colonize(app$1.get().game.choices[0], app$1.get().game.players[app$1.get().game.acting_player_index].limbo, app$1.get().game.players[app$1.get().game.acting_player_index].limbo.filter(el => {
              return el.type == "terraforming";
            })[0]);

            if (app$1.get().game.choices[0].hosted_colonies.length > 0) {
              let c = app$1.get().game.choices[0].hosted_colonies.reduce((acc, cur) => {
      ...
      //                  -> artificial_intelligence
      {
        ...
        "Adding Role Card to your Machine Learning Model": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "artificial_intelligence") {
            ...
            let _app$1$get3 = app$1.get(),
                game = _app$1$get3.game,
        ...
        "Adding Role Card to your Machine Learning Model": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "artificial_intelligence") {
            ...
            let _app$1$get4 = app$1.get(),
                game = _app$1$get4.game,
      ...
      //          -> research
      {
        ...
        "Removing the Selected Cards from the Game": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activeaction != "data_network" || app$1.get().game.choices[0].name == "Skip") {
            ...
            let _app$1$get5 = app$1.get(),
                game = _app$1$get5.game,
    ...
    //              -> conquer
    {
          ...
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole != "colonize" || app$1.get().game.choices[0].name != "Colonize") {
            ...
            for (let i = 0; i < app$1.get().game.players[app$1.get().game.acting_player_index].boostingicons.colonize; i++) {
              if (planet.hosted_colonies.length > 0) {
                if (planet.hosted_colonies.reduce((acc, cur) => {
                  return acc + cur.icons.colonize;
                }) >= planet.settle_cost && j < app$1.get().game.subchoices.length - 1) {
                  j++;
                  planet = app$1.get().game.subchoices[j];
                }
              }

              app$1.colonize(planet, app$1.get().game.players[app$1.get().game.acting_player_index].limbo, app$1.get().game.players[app$1.get().game.acting_player_index].limbo.filter(el => {
                return el.type == "colonize";
              })[0]);
            }
        ...
        "Researching your Technology": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole != "research") {
            ...
            if (game.choices[0].name != "Skip") {
              ...
              [...game.players[app$1.get().game.acting_player_index].settled_planets, ...game.players[app$1.get().game.acting_player_index].conquered_planets].map(el => {
                p[el.type]++;
              });
              let condition = true;
      ...
      //      -> survey
      {
        "Choose a Planet from your Galaxy to Explore": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole != "survey") {
            ...
            let game = app$1.get().game; //survey_role purchase, offer_to_boost explore_planet, present_as_choice, choose, catalog_planet, discard
      ...
      //              -> conquer
      {
        ...
        "You passed Priority": () => {
          let game = app$1.get().game; //app.togglepasstoplayer();
    ...
    //              -> conquer
    {
      follow: [{
        ...
        Dissenting: () => {
          ...
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole != "dissent") {
            let _app$1$get8 = app$1.get(),
                game = _app$1$get8.game,
      ...
      }, //will auto pass to next phase if follow has been selected
      {
        ...
        "Boosting your Role": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole == "dissent") {
            ...
            let _app$1$get9 = app$1.get(),
                game = _app$1$get9.game,
      ...
      //         -> colonize
      {
        "Choose between Settling or Colonizing a Planet": () => {
          if (app$1.get().game.players[app$1.get().game.acting_player_index].activerole != "colonize") {
            app$1.phasefinishfunction();
          } else if (app$1.get().game.players[app$1.get().game.acting_player_index].permanents.filter(el => {
    ...
    //  -> cleanup
    {
      cleanup: [{
        "Drawing up to your Hand Size": () => {
          ...
          if (app$1.get().game.started && app$1.checkforendgame() && game.players.reduce((t, p) => {
            return t + p.rounds;
